      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          >
            ...
            je suis à la recherche d’un emploi à temps plein ou temps partiel à
            partir d’octobre&nbsp;2026. Passionnée par l’univers de la
            communication et de la créativité digitale, j’ai eu l’opportunité,
            au cours de mes études, de développer des compétences très variées,
            notamment dans la conception visuelle ou encore dans la gestion de
            projets numériques.
          </motion.p>
